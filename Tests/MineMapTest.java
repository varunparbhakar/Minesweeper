...
//        Assert.assertEquals(testInsertMap.printMapWithIndicators(), "*1000");
    ...
    void insertIndicator() {
        ...
        Object[][] mineMap = testInsertMap.getMyMineMap();
        Assertions.assertEquals(mineMap[0][0].getClass(), Indicator.class);
        Assertions.assertEquals(mineMap[0][1].getClass(), Indicator.class);
        Assertions.assertEquals(mineMap[0][3].getClass(), Indicator.class);


        Assertions.assertEquals(mineMap[0][0].toString(), ".");
        Assertions.assertEquals(mineMap[0][1].toString(), ".");
        Assertions.assertEquals(mineMap[0][3].toString(), ".");
    }
...
//      We will check this to confirm and also confirm that the point (1, 1) has a bomb.
        Object[][] mineMap = testInsertMap.getMyMineMap();
        Assertions.assertEquals(((Indicator) mineMap[0][0]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(((Indicator) mineMap[0][1]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(((Indicator) mineMap[0][2]).getMyAdjacentBombs(), 0);

        Assertions.assertEquals(((Indicator) mineMap[1][0]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(mineMap[1][1].getClass(), Bomb.class);
        Assertions.assertEquals(((Indicator) mineMap[1][2]).getMyAdjacentBombs(), 0);

        Assertions.assertEquals(((Indicator) mineMap[2][0]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(((Indicator) mineMap[2][1]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(((Indicator) mineMap[2][2]).getMyAdjacentBombs(), 0);
...
//      count updated by 1. We also confirm that there is a bomb at point (1, 1).
        ...
        Assertions.assertEquals(((Indicator) mineMap[0][0]).getMyAdjacentBombs(), 1);
        Assertions.assertEquals(((Indicator) mineMap[0][1]).getMyAdjacentBombs(), 1);
        Assertions.assertEquals(((Indicator) mineMap[0][2]).getMyAdjacentBombs(), 1);

        Assertions.assertEquals(((Indicator) mineMap[1][0]).getMyAdjacentBombs(), 1);
        Assertions.assertEquals(mineMap[1][1].getClass(), Bomb.class);
        Assertions.assertEquals(((Indicator) mineMap[1][2]).getMyAdjacentBombs(), 1);

        Assertions.assertEquals(((Indicator) mineMap[2][0]).getMyAdjacentBombs(), 1);
        Assertions.assertEquals(((Indicator) mineMap[2][1]).getMyAdjacentBombs(), 1);
        Assertions.assertEquals(((Indicator) mineMap[2][2]).getMyAdjacentBombs(), 1);
    }
    ...
    void northLocationSet(){
        ...
        Assertions.assertEquals(((Indicator) mineMap[0][0]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(mineMap[1][0].getClass(), Bomb.class);
        Assertions.assertEquals(((Indicator) mineMap[2][0]).getMyAdjacentBombs(), 0);
    ...
    void westLocationSet() {
        ...
        Assertions.assertEquals(((Indicator) mineMap[0][0]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(mineMap[0][1].getClass(), Bomb.class);
        Assertions.assertEquals(((Indicator) mineMap[0][2]).getMyAdjacentBombs(), 0);
    ...
    void northWestLocationSet() {
        ...
        Assertions.assertEquals(((Indicator) mineMap[0][1]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(mineMap[1][0].getClass(), Bomb.class);
        Assertions.assertEquals(((Indicator) mineMap[1][1]).getMyAdjacentBombs(), 0);
    ...
    void southWestLocationSet() {
        ...
        Object[][] mineMap = oneByThreeTestMap.getMyMineMap();
        Assertions.assertEquals(mineMap[0][0].getClass(), Bomb.class);
        Assertions.assertEquals(((Indicator) mineMap[0][1]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(((Indicator) mineMap[1][0]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(((Indicator) mineMap[1][1]).getMyAdjacentBombs(), 0);
        ...
        Assertions.assertEquals(((Indicator) mineMap[0][1]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(((Indicator) mineMap[1][0]).getMyAdjacentBombs(), 0);
        Assertions.assertEquals(((Indicator) mineMap[1][1]).getMyAdjacentBombs(), 1);
    }
